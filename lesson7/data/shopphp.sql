...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 08 2021 г., 03:30
...
CREATE TABLE `product` (
  ...
  `image` text,
  `units` text NOT NULL DEFAULT (_utf8mb4'кг'),
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `product` (`id`, `title`, `text`, `price`, `count`, `image`, `units`, `created_at`) VALUES
(1, 'Авокадо', 'Авокадо — это плод дерева, которое по-научному называется Persea americana (Персея американская). Оно ценится за высокую питательность и насыщенную текстуру [1]. Авокадо очень популярно у сторонников здорового питания, его часто называют суперфудом из-за полезных свойств [2]. Известно несколько разновидностей авокадо, различаемых по форме, цвету, вкусовым качествам и весу (200 г — 1,4 кг). Родина авокадо — Центральная Америка и Мексика. Часто путаются с определением авокадо: по внешнему виду плод напоминает орех, по химическому составу и вкусовым качествам — овощ, однако авокадо считается фруктом.', 72, 2, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/avokado.jpg', 'шт', '2021-06-07 00:28:26'),
(2, 'Арбуз', 'Арбуз – один из любимых продуктов детей и многих взрослых. Но не все знают, как назвать эти сочные и сладкие плоды правильно. Чтобы выяснить, арбуз – это фрукт или все-таки ягода, для начала надо разобраться, что означают эти понятия.', 17, 0, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/arb.png', 'кг', '2021-06-07 00:27:50'),
(3, 'Айва', 'Если верить гомеровским писаниям, то айва или квитовое яблоко – это верховный фрукт в саду Гесперид. Именно там, в палисаднике персонажей древнегреческой мифологии, росли деревья с золотыми плодами. Выращивать айву начали примерно 2600 лет назад, следовательно, она является самой старой сельскохозяйственной культурой.', 82, 21, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/ayva.jpg', 'шт', '2021-06-06 23:55:28'),
(4, 'Абрикос', 'Абрикос – это листопадное дерево, входящее в семейство розовые. В высоту растение достигает 5-8 метров, ствол покрыт серо-бурой корой. Максимальный возраст деревьев 100 лет. Активно плодоносит в промежутке с 3 до 40 лет. Существуют дикая и одомашненная форма растения. Дикий абрикос сохранился только в Гималаях, горных районах Тянь-Шаня, Северного Кавказа.', 72, 12, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/abrikos.jpg', 'кг', '2021-06-06 23:53:30'),
(5, 'Ананас', 'Ананас – это плод многолетнего травянистого растения, родиной которого считается Южная Америка, именно там и его и обнаружил Христофор Колумб. Со временем культура распространилась по близлежащим континентам и в настоящее время культивируется во множестве стран: Австралия, Индия, Южная Америка, Филиппины и Гавайские острова.', 95, 13, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/pine.jpg', 'шт', '2021-06-06 23:55:53'),
(6, 'Ананас GOLD', 'Ананас Голд — это тропический фрукт, выращиваемый в теплых странах Южной Америки, Азии, Африки и по внешнему виду напоминающий большую шишку. Внутри нее скрывается желтая или золотая мякоть, которая отличается сочностью, сахарной сладостью и незабываемым ароматом.', 529, 20, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/anagold.jpg', 'кг', '2021-06-06 23:54:01'),
(7, 'Апельсины', 'Апельсины – это цитрусовые круглой формы, диаметром 5-10 сантиметров. Они имеют бугристую оранжевую кожуру, мясистую мякоть оранжевого цвета и косточки. Вкус зависит от сорта и меняется от сладкого до горького.', 72, 0, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/ap.jpg', 'кг', '2021-06-07 00:27:56'),
(8, 'Бананы', 'Бананы – это экзотические плоды эллиптической формы с кремообразной мякотью, покрытой плотной несъедобной кожурой. Банановое дерево может вырастать от 3 до 6 м в высоту. Плоды формируются группами по 50—150 штук, которые объединяются в кластеры по 10—25 штук.', 73, 17, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/ban.jpg', 'кг', '2021-06-06 23:55:21'),
(9, 'Виноград белый', 'Несмотря на название, под белым виноградом подразумеваются сорта, дающие урожай белых, зеленых и желтых плодов. Желтая и зеленая разновидности относятся к белому винограду, считаясь его подвидами. Белый виноград может быть разделен на две большие группы – столовую и техническую. Первая группа пригодна для употребления в пищу в свежем виде, вторая предназначается для переработки с целью приготовления вин и других продуктов. Существуют универсальные сорта, да и большинство столовых сортов вполне может выступить в роли сырья. В свою очередь, ягоды технических сортов в своей основной массе могут употребляться в пищу свежими. Однако специалисты предпочитают разделять эти две группы.', 102, 11, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/vin.jpg', 'кг', '2021-06-06 23:55:36'),
(10, 'Виноград Red Glode', 'Один из наиболее выращиваемых по всему миру сортов винограда Ред Глоб высоко оценен и селекционерами, и обычными покупателями. Эффектный вид гроздей, приятное освежающее сочетание сладости и кислоты в ягодах, узнаваемый оттенок кожицы — все это делает его привлекательным для выращивания. А также виноград встречается под названиями Красный Глобус, Красная Земля, Глобо Ройо, Роуз ЛТО. В России сорт выращивается в южных регионах, поскольку он очень теплолюбив. В США культивируется в климатической зоне Калифорнии и других южных штатов. Распространен в Китае и Японии, в Латинской Америке.', 96, 31, 'https://raw.githubusercontent.com/efrem005/json/master/responses/img/rg.jpg', 'кг', '2021-06-03 23:37:32');
...
(1, 'Николай', 'Вкусные', 5, '2021-06-04 00:49:18'),
(2, 'Анастасия', 'Очень вкусные', 5, '2021-06-04 00:49:18'),
(3, 'Вася', 'Что тут говорить', 5, '2021-06-04 01:21:30'),
(16, 'Николай', 'Очень вкусные апельсины', 7, '2021-06-04 01:49:25'),
(17, 'Анастасия', 'Вкусно', 7, '2021-06-04 01:50:36'),
(18, 'Анна', 'Очень вкусно', 7, '2021-06-04 01:52:36'),
(19, 'Николай', 'очень вкусные', 3, '2021-06-06 15:13:02'),
(20, 'Николай', 'очень вкусные', 3, '2021-06-06 15:13:06'),
(21, 'fgfdgdfgdfg', 'dfgdfg\r\n', 3, '2021-06-06 18:58:28'),
(22, 'fgfdgdfgdfg', 'dfgdfg\r\n', 3, '2021-06-06 18:58:33');
...
INSERT INTO `users` (`id`, `login`, `pass`, `pass_hash`) VALUES
(1, 'mr.Bin', '123', NULL),
(2, 'Admin', '123', NULL);
